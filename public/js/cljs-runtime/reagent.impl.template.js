...
var G__52048 = o;
goog.object.set(G__52048,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__52049 = o;
goog.object.set(G__52049,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__52164__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__52164 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__52165__i = 0, G__52165__a = new Array(arguments.length -  0);
while (G__52165__i < G__52165__a.length) {G__52165__a[G__52165__i] = arguments[G__52165__i + 0]; ++G__52165__i;}
  args = new cljs.core.IndexedSeq(G__52165__a,0,null);
} 
return G__52164__delegate.call(this,args);};
G__52164.cljs$lang$maxFixedArity = 0;
G__52164.cljs$lang$applyTo = (function (arglist__52167){
var args = cljs.core.seq(arglist__52167);
return G__52164__delegate(args);
});
G__52164.cljs$core$IFn$_invoke$arity$variadic = G__52164__delegate;
return G__52164;
})()
;
} else {
...
var G__52050 = props;
var G__52050__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52050,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__52050);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52050__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__52051 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52051,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__52051;
}
})(),id_class);
...
var G__52052 = (cljs.core.count(argv) - first_child);
switch (G__52052) {
case (0):
...
var vec__52053 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52053,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52053,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52053,(2),null);
...
var temp__5739__auto___52169 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___52169 == null)){
} else {
var key_52170 = temp__5739__auto___52169;
(jsprops.key = key_52170);
}
...
var temp__5739__auto___52173 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___52173 == null)){
} else {
var key_52174 = temp__5739__auto___52173;
(jsprops.key = key_52174);
}
...
var temp__5739__auto___52175 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___52175 == null)){
} else {
var key_52176 = temp__5739__auto___52175;
(jsprops.key = key_52176);
}
...
var temp__5739__auto___52211 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___52211 == null)){
} else {
var key_52212 = temp__5739__auto___52211;
(jsprops.key = key_52212);
}
...
var temp__5739__auto___52213 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___52213 == null)){
} else {
var key_52214 = temp__5739__auto___52213;
(jsprops.key = key_52214);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52056_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__52056_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__52057 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52057,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52057,(1),null);
...
break;
default:
var G__52241 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__52242 = compiler;
v = G__52241;
compiler = G__52242;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template52063 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template52063 = (function (opts,id,fn_to_element,parse_fn,meta52064){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template52063.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_52065,meta52064__$1){
var self__ = this;
var _52065__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template52063(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta52064__$1));
}));

(reagent.impl.template.t_reagent$impl$template52063.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_52065){
var self__ = this;
var _52065__$1 = this;
return self__.meta52064;
}));

(reagent.impl.template.t_reagent$impl$template52063.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template52063.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template52063.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template52063.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template52063.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template52063.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta52064","meta52064",-896181852,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template52063.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template52063.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template52063");

(reagent.impl.template.t_reagent$impl$template52063.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template52063");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template52063.
 */
reagent.impl.template.__GT_t_reagent$impl$template52063 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template52063(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta52064){
return (new reagent.impl.template.t_reagent$impl$template52063(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta52064));
});

}

return (new reagent.impl.template.t_reagent$impl$template52063(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
