...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41728 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41728(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41732 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41732(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41739 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41739(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41796 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41796(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41802 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41802(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41806 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41806(reader);
}
});
...
var G__41993 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__41994 = s.append(c);
c = G__41993;
s = G__41994;
continue;
}
