...
var measure_49706 = measures.info.current_measure();
var new_value_49707__$1 = (function (){var fexpr__49688 = (cljs.core.truth_((measures.db.numeric_fields.cljs$core$IFn$_invoke$arity$1 ? measures.db.numeric_fields.cljs$core$IFn$_invoke$arity$1(field) : measures.db.numeric_fields.call(null,field)))?Number:cljs.core.identity);
return (fexpr__49688.cljs$core$IFn$_invoke$arity$1 ? fexpr__49688.cljs$core$IFn$_invoke$arity$1(new_value) : fexpr__49688.call(null,new_value));
})();
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(field,new cljs.core.Keyword(null,"baseline","baseline",1151033280))){
var r_49708 = new_value_49707__$1;
var p_49709 = (function (){var G__49690 = new_value_49707__$1;
var G__49691 = (function (){var G__49693 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(measure_49706);
var fexpr__49692 = cljs.core.deref(ref);
return (fexpr__49692.cljs$core$IFn$_invoke$arity$1 ? fexpr__49692.cljs$core$IFn$_invoke$arity$1(G__49693) : fexpr__49692.call(null,G__49693));
})();
var fexpr__49689 = new cljs.core.Keyword(null,"calc-final","calc-final",1060997511).cljs$core$IFn$_invoke$arity$1(measure_49706);
return (fexpr__49689.cljs$core$IFn$_invoke$arity$2 ? fexpr__49689.cljs$core$IFn$_invoke$arity$2(G__49690,G__49691) : fexpr__49689.call(null,G__49690,G__49691));
})();
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(ref,cljs.core.assoc,new cljs.core.Keyword(null,"final","final",1157881357),measures.views.safe(p_49709,(3)));

console.log(["r-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(measure_49706)),"->p "].join(''),r_49708,p_49709);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(field,new cljs.core.Keyword(null,"final","final",1157881357))){
var r_49710 = new cljs.core.Keyword(null,"baseline","baseline",1151033280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(ref));
var p_49711 = new_value_49707__$1;
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(ref,cljs.core.assoc,new cljs.core.Keyword(null,"baseline","baseline",1151033280),measures.views.safe(r_49710,(3)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"RR","RR",-1849589574),measures.views.safe(measures.info.r_p__GT_RR(r_49710,p_49711),(2)),new cljs.core.Keyword(null,"PC","PC",-2096819416),measures.views.safe(measures.info.r_p__GT_PC(r_49710,p_49711),(1)),new cljs.core.Keyword(null,"OR","OR",-1220615924),measures.views.safe(measures.info.r_p__GT_OR(r_49710,p_49711),(2)),new cljs.core.Keyword(null,"HR","HR",1056134531),measures.views.safe(measures.info.r_p__GT_HR(r_49710,p_49711),(2))], 0));

console.log(["(r-p","->",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(measure_49706))].join(''),r_49710,p_49711);
} else {
var r_49712 = Number(new cljs.core.Keyword(null,"baseline","baseline",1151033280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(ref)));
var p_49713 = (function (){var fexpr__49694 = new cljs.core.Keyword(null,"calc-final","calc-final",1060997511).cljs$core$IFn$_invoke$arity$1(measure_49706);
return (fexpr__49694.cljs$core$IFn$_invoke$arity$2 ? fexpr__49694.cljs$core$IFn$_invoke$arity$2(r_49712,new_value_49707__$1) : fexpr__49694.call(null,r_49712,new_value_49707__$1));
})();
console.log("r-",new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(measure_49706),"->p ",r_49712,p_49713);

cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(ref,cljs.core.assoc,new cljs.core.Keyword(null,"final","final",1157881357),measures.views.safe(p_49713,(3)));

cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(ref,cljs.core.assoc,new cljs.core.Keyword(null,"RR","RR",-1849589574),measures.views.safe(measures.info.r_p__GT_RR(r_49712,p_49713),(2)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"PC","PC",-2096819416),measures.views.safe(measures.info.r_p__GT_PC(r_49712,p_49713),(1)),new cljs.core.Keyword(null,"OR","OR",-1220615924),measures.views.safe(measures.info.r_p__GT_OR(r_49712,p_49713),(2)),new cljs.core.Keyword(null,"HR","HR",1056134531),measures.views.safe(measures.info.r_p__GT_HR(r_49712,p_49713),(2))], 0));
...
var vec__49695 = measures.views.maybe_value(ref,field,new_value);
var err_field = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49695,(0),null);
var good_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49695,(1),null);
var error = vec__49695;
...
var fexpr__49698 = measures.info.measure_by(field);
return (fexpr__49698.cljs$core$IFn$_invoke$arity$1 ? fexpr__49698.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"step","step",1288888124)) : fexpr__49698.call(null,new cljs.core.Keyword(null,"step","step",1288888124)));
});
...
return measures.views.safe((function (){var fexpr__49699 = cljs.core.deref(ref);
return (fexpr__49699.cljs$core$IFn$_invoke$arity$1 ? fexpr__49699.cljs$core$IFn$_invoke$arity$1(field) : fexpr__49699.call(null,field));
})(),(cljs.core.truth_((function (){var fexpr__49700 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"baseline","baseline",1151033280),null,new cljs.core.Keyword(null,"final","final",1157881357),null], null), null);
return (fexpr__49700.cljs$core$IFn$_invoke$arity$1 ? fexpr__49700.cljs$core$IFn$_invoke$arity$1(field) : fexpr__49700.call(null,field));
...
var final$ = Number((function (){var G__49704 = new cljs.core.Keyword(null,"baseline","baseline",1151033280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(measures.db.state));
var G__49705 = new cljs.core.Keyword(null,"measure-value","measure-value",-185107611).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(measures.db.state));
var fexpr__49703 = new cljs.core.Keyword(null,"calc-final","calc-final",1060997511).cljs$core$IFn$_invoke$arity$1(measure);
return (fexpr__49703.cljs$core$IFn$_invoke$arity$2 ? fexpr__49703.cljs$core$IFn$_invoke$arity$2(G__49704,G__49705) : fexpr__49703.call(null,G__49704,G__49705));
})());
