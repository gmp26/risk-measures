...
var measure_48156 = measures.info.current_measure();
var new_value_48157__$1 = (function (){var fexpr__48135 = (cljs.core.truth_((measures.db.numeric_fields.cljs$core$IFn$_invoke$arity$1 ? measures.db.numeric_fields.cljs$core$IFn$_invoke$arity$1(field) : measures.db.numeric_fields.call(null,field)))?Number:cljs.core.identity);
return (fexpr__48135.cljs$core$IFn$_invoke$arity$1 ? fexpr__48135.cljs$core$IFn$_invoke$arity$1(new_value) : fexpr__48135.call(null,new_value));
})();
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(field,new cljs.core.Keyword(null,"baseline","baseline",1151033280))){
var r_48158 = new_value_48157__$1;
var p_48159 = (function (){var G__48137 = new_value_48157__$1;
var G__48138 = (function (){var G__48140 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(measure_48156);
var fexpr__48139 = cljs.core.deref(ref);
return (fexpr__48139.cljs$core$IFn$_invoke$arity$1 ? fexpr__48139.cljs$core$IFn$_invoke$arity$1(G__48140) : fexpr__48139.call(null,G__48140));
})();
var fexpr__48136 = new cljs.core.Keyword(null,"calc-final","calc-final",1060997511).cljs$core$IFn$_invoke$arity$1(measure_48156);
return (fexpr__48136.cljs$core$IFn$_invoke$arity$2 ? fexpr__48136.cljs$core$IFn$_invoke$arity$2(G__48137,G__48138) : fexpr__48136.call(null,G__48137,G__48138));
})();
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(ref,cljs.core.assoc,new cljs.core.Keyword(null,"final","final",1157881357),measures.views.safe(p_48159,(3)));

console.log(["r-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(measure_48156)),"->p "].join(''),r_48158,p_48159);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(field,new cljs.core.Keyword(null,"final","final",1157881357))){
var r_48161 = new cljs.core.Keyword(null,"baseline","baseline",1151033280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(ref));
var p_48162 = new_value_48157__$1;
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(ref,cljs.core.assoc,new cljs.core.Keyword(null,"baseline","baseline",1151033280),measures.views.safe(r_48161,(3)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"RR","RR",-1849589574),measures.views.safe(measures.info.r_p__GT_RR(r_48161,p_48162),(2)),new cljs.core.Keyword(null,"PC","PC",-2096819416),measures.views.safe(measures.info.r_p__GT_PC(r_48161,p_48162),(1)),new cljs.core.Keyword(null,"OR","OR",-1220615924),measures.views.safe(measures.info.r_p__GT_OR(r_48161,p_48162),(2)),new cljs.core.Keyword(null,"HR","HR",1056134531),measures.views.safe(measures.info.r_p__GT_HR(r_48161,p_48162),(2))], 0));

console.log(["(r-p","->",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(measure_48156))].join(''),r_48161,p_48162);
} else {
var r_48163 = Number(new cljs.core.Keyword(null,"baseline","baseline",1151033280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(ref)));
var p_48164 = (function (){var fexpr__48141 = new cljs.core.Keyword(null,"calc-final","calc-final",1060997511).cljs$core$IFn$_invoke$arity$1(measure_48156);
return (fexpr__48141.cljs$core$IFn$_invoke$arity$2 ? fexpr__48141.cljs$core$IFn$_invoke$arity$2(r_48163,new_value_48157__$1) : fexpr__48141.call(null,r_48163,new_value_48157__$1));
})();
console.log("r-",new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(measure_48156),"->p ",r_48163,p_48164);

cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(ref,cljs.core.assoc,new cljs.core.Keyword(null,"final","final",1157881357),measures.views.safe(p_48164,(3)));

cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(ref,cljs.core.assoc,new cljs.core.Keyword(null,"RR","RR",-1849589574),measures.views.safe(measures.info.r_p__GT_RR(r_48163,p_48164),(2)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"PC","PC",-2096819416),measures.views.safe(measures.info.r_p__GT_PC(r_48163,p_48164),(1)),new cljs.core.Keyword(null,"OR","OR",-1220615924),measures.views.safe(measures.info.r_p__GT_OR(r_48163,p_48164),(2)),new cljs.core.Keyword(null,"HR","HR",1056134531),measures.views.safe(measures.info.r_p__GT_HR(r_48163,p_48164),(2))], 0));
...
var vec__48142 = measures.views.maybe_value(ref,field,new_value);
var err_field = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48142,(0),null);
var good_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48142,(1),null);
var error = vec__48142;
...
var fexpr__48145 = measures.info.measure_by(field);
return (fexpr__48145.cljs$core$IFn$_invoke$arity$1 ? fexpr__48145.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"step","step",1288888124)) : fexpr__48145.call(null,new cljs.core.Keyword(null,"step","step",1288888124)));
});
...
return measures.views.safe((function (){var fexpr__48146 = cljs.core.deref(ref);
return (fexpr__48146.cljs$core$IFn$_invoke$arity$1 ? fexpr__48146.cljs$core$IFn$_invoke$arity$1(field) : fexpr__48146.call(null,field));
})(),(cljs.core.truth_((function (){var fexpr__48147 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"baseline","baseline",1151033280),null,new cljs.core.Keyword(null,"final","final",1157881357),null], null), null);
return (fexpr__48147.cljs$core$IFn$_invoke$arity$1 ? fexpr__48147.cljs$core$IFn$_invoke$arity$1(field) : fexpr__48147.call(null,field));
...
var final$ = Number((function (){var G__48151 = new cljs.core.Keyword(null,"baseline","baseline",1151033280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(measures.db.state));
var G__48152 = new cljs.core.Keyword(null,"measure-value","measure-value",-185107611).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(measures.db.state));
var fexpr__48150 = new cljs.core.Keyword(null,"calc-final","calc-final",1060997511).cljs$core$IFn$_invoke$arity$1(measure);
return (fexpr__48150.cljs$core$IFn$_invoke$arity$2 ? fexpr__48150.cljs$core$IFn$_invoke$arity$2(G__48151,G__48152) : fexpr__48150.call(null,G__48151,G__48152));
})());
