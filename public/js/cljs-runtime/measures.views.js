...
var measure_49678 = measures.info.current_measure();
var new_value_49679__$1 = (function (){var fexpr__49657 = (cljs.core.truth_((measures.db.numeric_fields.cljs$core$IFn$_invoke$arity$1 ? measures.db.numeric_fields.cljs$core$IFn$_invoke$arity$1(field) : measures.db.numeric_fields.call(null,field)))?Number:cljs.core.identity);
return (fexpr__49657.cljs$core$IFn$_invoke$arity$1 ? fexpr__49657.cljs$core$IFn$_invoke$arity$1(new_value) : fexpr__49657.call(null,new_value));
})();
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(field,new cljs.core.Keyword(null,"baseline","baseline",1151033280))){
var r_49680 = new_value_49679__$1;
var p_49681 = (function (){var G__49659 = new_value_49679__$1;
var G__49660 = (function (){var G__49662 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(measure_49678);
var fexpr__49661 = cljs.core.deref(ref);
return (fexpr__49661.cljs$core$IFn$_invoke$arity$1 ? fexpr__49661.cljs$core$IFn$_invoke$arity$1(G__49662) : fexpr__49661.call(null,G__49662));
})();
var fexpr__49658 = new cljs.core.Keyword(null,"calc-final","calc-final",1060997511).cljs$core$IFn$_invoke$arity$1(measure_49678);
return (fexpr__49658.cljs$core$IFn$_invoke$arity$2 ? fexpr__49658.cljs$core$IFn$_invoke$arity$2(G__49659,G__49660) : fexpr__49658.call(null,G__49659,G__49660));
})();
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(ref,cljs.core.assoc,new cljs.core.Keyword(null,"final","final",1157881357),measures.views.safe(p_49681,(3)));

console.log(["r-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(measure_49678)),"->p "].join(''),r_49680,p_49681);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(field,new cljs.core.Keyword(null,"final","final",1157881357))){
var r_49683 = new cljs.core.Keyword(null,"baseline","baseline",1151033280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(ref));
var p_49684 = new_value_49679__$1;
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(ref,cljs.core.assoc,new cljs.core.Keyword(null,"baseline","baseline",1151033280),measures.views.safe(r_49683,(3)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"RR","RR",-1849589574),measures.views.safe(measures.info.r_p__GT_RR(r_49683,p_49684),(2)),new cljs.core.Keyword(null,"PC","PC",-2096819416),measures.views.safe(measures.info.r_p__GT_PC(r_49683,p_49684),(1)),new cljs.core.Keyword(null,"OR","OR",-1220615924),measures.views.safe(measures.info.r_p__GT_OR(r_49683,p_49684),(2)),new cljs.core.Keyword(null,"HR","HR",1056134531),measures.views.safe(measures.info.r_p__GT_HR(r_49683,p_49684),(2))], 0));

console.log(["(r-p","->",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(measure_49678))].join(''),r_49683,p_49684);
} else {
var r_49685 = Number(new cljs.core.Keyword(null,"baseline","baseline",1151033280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(ref)));
var p_49686 = (function (){var fexpr__49663 = new cljs.core.Keyword(null,"calc-final","calc-final",1060997511).cljs$core$IFn$_invoke$arity$1(measure_49678);
return (fexpr__49663.cljs$core$IFn$_invoke$arity$2 ? fexpr__49663.cljs$core$IFn$_invoke$arity$2(r_49685,new_value_49679__$1) : fexpr__49663.call(null,r_49685,new_value_49679__$1));
})();
console.log("r-",new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(measure_49678),"->p ",r_49685,p_49686);

cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(ref,cljs.core.assoc,new cljs.core.Keyword(null,"final","final",1157881357),measures.views.safe(p_49686,(3)));

cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(ref,cljs.core.assoc,new cljs.core.Keyword(null,"RR","RR",-1849589574),measures.views.safe(measures.info.r_p__GT_RR(r_49685,p_49686),(2)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"PC","PC",-2096819416),measures.views.safe(measures.info.r_p__GT_PC(r_49685,p_49686),(1)),new cljs.core.Keyword(null,"OR","OR",-1220615924),measures.views.safe(measures.info.r_p__GT_OR(r_49685,p_49686),(2)),new cljs.core.Keyword(null,"HR","HR",1056134531),measures.views.safe(measures.info.r_p__GT_HR(r_49685,p_49686),(2))], 0));
...
var vec__49664 = measures.views.maybe_value(ref,field,new_value);
var err_field = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49664,(0),null);
var good_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49664,(1),null);
var error = vec__49664;
...
var fexpr__49667 = measures.info.measure_by(field);
return (fexpr__49667.cljs$core$IFn$_invoke$arity$1 ? fexpr__49667.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"step","step",1288888124)) : fexpr__49667.call(null,new cljs.core.Keyword(null,"step","step",1288888124)));
});
...
return measures.views.safe((function (){var fexpr__49668 = cljs.core.deref(ref);
return (fexpr__49668.cljs$core$IFn$_invoke$arity$1 ? fexpr__49668.cljs$core$IFn$_invoke$arity$1(field) : fexpr__49668.call(null,field));
})(),(cljs.core.truth_((function (){var fexpr__49669 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"baseline","baseline",1151033280),null,new cljs.core.Keyword(null,"final","final",1157881357),null], null), null);
return (fexpr__49669.cljs$core$IFn$_invoke$arity$1 ? fexpr__49669.cljs$core$IFn$_invoke$arity$1(field) : fexpr__49669.call(null,field));
...
var final$ = Number((function (){var G__49673 = new cljs.core.Keyword(null,"baseline","baseline",1151033280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(measures.db.state));
var G__49674 = new cljs.core.Keyword(null,"measure-value","measure-value",-185107611).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(measures.db.state));
var fexpr__49672 = new cljs.core.Keyword(null,"calc-final","calc-final",1060997511).cljs$core$IFn$_invoke$arity$1(measure);
return (fexpr__49672.cljs$core$IFn$_invoke$arity$2 ? fexpr__49672.cljs$core$IFn$_invoke$arity$2(G__49673,G__49674) : fexpr__49672.call(null,G__49673,G__49674));
})());
