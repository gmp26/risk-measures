...
var measure_47780 = measures.info.current_measure();
var new_value_47781__$1 = (function (){var fexpr__47759 = (cljs.core.truth_((measures.db.numeric_fields.cljs$core$IFn$_invoke$arity$1 ? measures.db.numeric_fields.cljs$core$IFn$_invoke$arity$1(field) : measures.db.numeric_fields.call(null,field)))?Number:cljs.core.identity);
return (fexpr__47759.cljs$core$IFn$_invoke$arity$1 ? fexpr__47759.cljs$core$IFn$_invoke$arity$1(new_value) : fexpr__47759.call(null,new_value));
})();
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(field,new cljs.core.Keyword(null,"baseline","baseline",1151033280))){
var r_47782 = new_value_47781__$1;
var p_47783 = (function (){var G__47761 = new_value_47781__$1;
var G__47762 = (function (){var G__47764 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(measure_47780);
var fexpr__47763 = cljs.core.deref(ref);
...
var fexpr__47760 = new cljs.core.Keyword(null,"calc-final","calc-final",1060997511).cljs$core$IFn$_invoke$arity$1(measure_47780);
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(ref,cljs.core.assoc,new cljs.core.Keyword(null,"final","final",1157881357),measures.views.safe(p_47783,(3)));

console.log(["r-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(measure_47780)),"->p "].join(''),r_47782,p_47783);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(field,new cljs.core.Keyword(null,"final","final",1157881357))){
var r_47785 = new cljs.core.Keyword(null,"baseline","baseline",1151033280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(ref));
var p_47786 = new_value_47781__$1;
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(ref,cljs.core.assoc,new cljs.core.Keyword(null,"baseline","baseline",1151033280),measures.views.safe(r_47785,(3)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"RR","RR",-1849589574),measures.views.safe(measures.info.r_p__GT_RR(r_47785,p_47786),(2)),new cljs.core.Keyword(null,"PC","PC",-2096819416),measures.views.safe(measures.info.r_p__GT_PC(r_47785,p_47786),(1)),new cljs.core.Keyword(null,"OR","OR",-1220615924),measures.views.safe(measures.info.r_p__GT_OR(r_47785,p_47786),(2)),new cljs.core.Keyword(null,"HR","HR",1056134531),measures.views.safe(measures.info.r_p__GT_HR(r_47785,p_47786),(2))], 0));

console.log(["(r-p","->",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(measure_47780))].join(''),r_47785,p_47786);
} else {
var r_47787 = Number(new cljs.core.Keyword(null,"baseline","baseline",1151033280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(ref)));
var p_47788 = (function (){var fexpr__47765 = new cljs.core.Keyword(null,"calc-final","calc-final",1060997511).cljs$core$IFn$_invoke$arity$1(measure_47780);
return (fexpr__47765.cljs$core$IFn$_invoke$arity$2 ? fexpr__47765.cljs$core$IFn$_invoke$arity$2(r_47787,new_value_47781__$1) : fexpr__47765.call(null,r_47787,new_value_47781__$1));
})();
console.log("r-",new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(measure_47780),"->p ",r_47787,p_47788);

cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(ref,cljs.core.assoc,new cljs.core.Keyword(null,"final","final",1157881357),measures.views.safe(p_47788,(3)));

cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(ref,cljs.core.assoc,new cljs.core.Keyword(null,"RR","RR",-1849589574),measures.views.safe(measures.info.r_p__GT_RR(r_47787,p_47788),(2)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"PC","PC",-2096819416),measures.views.safe(measures.info.r_p__GT_PC(r_47787,p_47788),(1)),new cljs.core.Keyword(null,"OR","OR",-1220615924),measures.views.safe(measures.info.r_p__GT_OR(r_47787,p_47788),(2)),new cljs.core.Keyword(null,"HR","HR",1056134531),measures.views.safe(measures.info.r_p__GT_HR(r_47787,p_47788),(2))], 0));
...
var vec__47766 = measures.views.maybe_value(ref,field,new_value);
var err_field = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47766,(0),null);
var good_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47766,(1),null);
var error = vec__47766;
...
var fexpr__47769 = measures.info.measure_by(field);
return (fexpr__47769.cljs$core$IFn$_invoke$arity$1 ? fexpr__47769.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"step","step",1288888124)) : fexpr__47769.call(null,new cljs.core.Keyword(null,"step","step",1288888124)));
});
...
return measures.views.safe((function (){var fexpr__47770 = cljs.core.deref(ref);
return (fexpr__47770.cljs$core$IFn$_invoke$arity$1 ? fexpr__47770.cljs$core$IFn$_invoke$arity$1(field) : fexpr__47770.call(null,field));
})(),(cljs.core.truth_((function (){var fexpr__47771 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"baseline","baseline",1151033280),null,new cljs.core.Keyword(null,"final","final",1157881357),null], null), null);
return (fexpr__47771.cljs$core$IFn$_invoke$arity$1 ? fexpr__47771.cljs$core$IFn$_invoke$arity$1(field) : fexpr__47771.call(null,field));
...
measures.views.field = new cljs.core.Keyword(null,"final","final",1157881357);
measures.views.status = (function measures$views$status(){
var measure = measures.info.current_measure();
var final$ = Number((function (){var G__47775 = new cljs.core.Keyword(null,"baseline","baseline",1151033280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(measures.db.state));
var G__47776 = new cljs.core.Keyword(null,"measure-value","measure-value",-185107611).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(measures.db.state));
var fexpr__47774 = new cljs.core.Keyword(null,"calc-final","calc-final",1060997511).cljs$core$IFn$_invoke$arity$1(measure);
return (fexpr__47774.cljs$core$IFn$_invoke$arity$2 ? fexpr__47774.cljs$core$IFn$_invoke$arity$2(G__47775,G__47776) : fexpr__47774.call(null,G__47775,G__47776));
})());
...
return new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"section","section",-300141526),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"ml-4 mt-2 first-letter:flex flex-col w-auto min-w-80"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"b","b",1482224470),"Status"], null),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p.ml-4","p.ml-4",542328951),"The baseline risk is ",measures.views.safe(new cljs.core.Keyword(null,"baseline","baseline",1151033280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(measures.db.state)),(3))," or ",measures.views.safe(((100) * new cljs.core.Keyword(null,"baseline","baseline",1151033280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(measures.db.state))),(1)),"%"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p.ml-4","p.ml-4",542328951),["The ",clojure.string.lower_case(new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(measures.info.measure_by(new cljs.core.Keyword(null,"RR","RR",-1849589574))))," is "].join(''),new cljs.core.Keyword(null,"RR","RR",-1849589574).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(measures.db.state))], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p.ml-4","p.ml-4",542328951),["The ",clojure.string.lower_case(new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(measures.info.measure_by(new cljs.core.Keyword(null,"PC","PC",-2096819416))))," is "].join(''),new cljs.core.Keyword(null,"PC","PC",-2096819416).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(measures.db.state))], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p.ml-4","p.ml-4",542328951),["The ",clojure.string.lower_case(new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(measures.info.measure_by(new cljs.core.Keyword(null,"OR","OR",-1220615924))))," is "].join(''),new cljs.core.Keyword(null,"OR","OR",-1220615924).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(measures.db.state))], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p.ml-4","p.ml-4",542328951),["The ",clojure.string.lower_case(new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(measures.info.measure_by(new cljs.core.Keyword(null,"HR","HR",1056134531))))," is "].join(''),new cljs.core.Keyword(null,"HR","HR",1056134531).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(measures.db.state))], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p.ml-4","p.ml-4",542328951),"So the final risk is ",new cljs.core.Keyword(null,"final","final",1157881357).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(measures.db.state))], null)], null);
});
/**
 * Render any errors
 */
