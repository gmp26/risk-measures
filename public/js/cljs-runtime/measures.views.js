...
var measure_49644 = measures.info.current_measure();
var new_value_49645__$1 = (function (){var fexpr__49626 = (cljs.core.truth_((measures.db.numeric_fields.cljs$core$IFn$_invoke$arity$1 ? measures.db.numeric_fields.cljs$core$IFn$_invoke$arity$1(field) : measures.db.numeric_fields.call(null,field)))?Number:cljs.core.identity);
return (fexpr__49626.cljs$core$IFn$_invoke$arity$1 ? fexpr__49626.cljs$core$IFn$_invoke$arity$1(new_value) : fexpr__49626.call(null,new_value));
})();
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(field,new cljs.core.Keyword(null,"baseline","baseline",1151033280))){
var r_49646 = new_value_49645__$1;
var p_49647 = (function (){var G__49628 = new_value_49645__$1;
var G__49629 = (function (){var G__49631 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(measure_49644);
var fexpr__49630 = cljs.core.deref(ref);
return (fexpr__49630.cljs$core$IFn$_invoke$arity$1 ? fexpr__49630.cljs$core$IFn$_invoke$arity$1(G__49631) : fexpr__49630.call(null,G__49631));
})();
var fexpr__49627 = new cljs.core.Keyword(null,"calc-final","calc-final",1060997511).cljs$core$IFn$_invoke$arity$1(measure_49644);
return (fexpr__49627.cljs$core$IFn$_invoke$arity$2 ? fexpr__49627.cljs$core$IFn$_invoke$arity$2(G__49628,G__49629) : fexpr__49627.call(null,G__49628,G__49629));
})();
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(ref,cljs.core.assoc,new cljs.core.Keyword(null,"final","final",1157881357),measures.views.safe(p_49647,(3)));

console.log(["r-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(measure_49644)),"->p "].join(''),r_49646,p_49647);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(field,new cljs.core.Keyword(null,"final","final",1157881357))){
var r_49648 = new cljs.core.Keyword(null,"baseline","baseline",1151033280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(ref));
var p_49649 = new_value_49645__$1;
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(ref,cljs.core.assoc,new cljs.core.Keyword(null,"baseline","baseline",1151033280),measures.views.safe(r_49648,(3)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"RR","RR",-1849589574),measures.views.safe(measures.info.r_p__GT_RR(r_49648,p_49649),(2)),new cljs.core.Keyword(null,"PC","PC",-2096819416),measures.views.safe(measures.info.r_p__GT_PC(r_49648,p_49649),(1)),new cljs.core.Keyword(null,"OR","OR",-1220615924),measures.views.safe(measures.info.r_p__GT_OR(r_49648,p_49649),(2)),new cljs.core.Keyword(null,"HR","HR",1056134531),measures.views.safe(measures.info.r_p__GT_HR(r_49648,p_49649),(2))], 0));

console.log(["(r-p","->",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(measure_49644))].join(''),r_49648,p_49649);
} else {
var r_49650 = Number(new cljs.core.Keyword(null,"baseline","baseline",1151033280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(ref)));
var p_49651 = (function (){var fexpr__49632 = new cljs.core.Keyword(null,"calc-final","calc-final",1060997511).cljs$core$IFn$_invoke$arity$1(measure_49644);
return (fexpr__49632.cljs$core$IFn$_invoke$arity$2 ? fexpr__49632.cljs$core$IFn$_invoke$arity$2(r_49650,new_value_49645__$1) : fexpr__49632.call(null,r_49650,new_value_49645__$1));
})();
console.log("r-",new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(measure_49644),"->p ",r_49650,p_49651);

cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(ref,cljs.core.assoc,new cljs.core.Keyword(null,"final","final",1157881357),measures.views.safe(p_49651,(3)));

cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(ref,cljs.core.assoc,new cljs.core.Keyword(null,"RR","RR",-1849589574),measures.views.safe(measures.info.r_p__GT_RR(r_49650,p_49651),(2)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"PC","PC",-2096819416),measures.views.safe(measures.info.r_p__GT_PC(r_49650,p_49651),(1)),new cljs.core.Keyword(null,"OR","OR",-1220615924),measures.views.safe(measures.info.r_p__GT_OR(r_49650,p_49651),(2)),new cljs.core.Keyword(null,"HR","HR",1056134531),measures.views.safe(measures.info.r_p__GT_HR(r_49650,p_49651),(2))], 0));
...
var vec__49633 = measures.views.maybe_value(ref,field,new_value);
var err_field = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49633,(0),null);
var good_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49633,(1),null);
var error = vec__49633;
...
var fexpr__49636 = measures.info.measure_by(field);
return (fexpr__49636.cljs$core$IFn$_invoke$arity$1 ? fexpr__49636.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"step","step",1288888124)) : fexpr__49636.call(null,new cljs.core.Keyword(null,"step","step",1288888124)));
});
...
return measures.views.safe((function (){var fexpr__49637 = cljs.core.deref(ref);
return (fexpr__49637.cljs$core$IFn$_invoke$arity$1 ? fexpr__49637.cljs$core$IFn$_invoke$arity$1(field) : fexpr__49637.call(null,field));
})(),(cljs.core.truth_((function (){var fexpr__49638 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"baseline","baseline",1151033280),null,new cljs.core.Keyword(null,"final","final",1157881357),null], null), null);
return (fexpr__49638.cljs$core$IFn$_invoke$arity$1 ? fexpr__49638.cljs$core$IFn$_invoke$arity$1(field) : fexpr__49638.call(null,field));
...
var final$ = Number((function (){var G__49642 = new cljs.core.Keyword(null,"baseline","baseline",1151033280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(measures.db.state));
var G__49643 = new cljs.core.Keyword(null,"measure-value","measure-value",-185107611).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(measures.db.state));
var fexpr__49641 = new cljs.core.Keyword(null,"calc-final","calc-final",1060997511).cljs$core$IFn$_invoke$arity$1(measure);
return (fexpr__49641.cljs$core$IFn$_invoke$arity$2 ? fexpr__49641.cljs$core$IFn$_invoke$arity$2(G__49642,G__49643) : fexpr__49641.call(null,G__49642,G__49643));
})());
