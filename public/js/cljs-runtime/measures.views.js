...
var measure_49366 = measures.info.current_measure();
var new_value_49367__$1 = (function (){var fexpr__49345 = (cljs.core.truth_((measures.db.numeric_fields.cljs$core$IFn$_invoke$arity$1 ? measures.db.numeric_fields.cljs$core$IFn$_invoke$arity$1(field) : measures.db.numeric_fields.call(null,field)))?Number:cljs.core.identity);
return (fexpr__49345.cljs$core$IFn$_invoke$arity$1 ? fexpr__49345.cljs$core$IFn$_invoke$arity$1(new_value) : fexpr__49345.call(null,new_value));
})();
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(field,new cljs.core.Keyword(null,"baseline","baseline",1151033280))){
var r_49368 = new_value_49367__$1;
var p_49369 = (function (){var G__49347 = new_value_49367__$1;
var G__49348 = (function (){var G__49350 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(measure_49366);
var fexpr__49349 = cljs.core.deref(ref);
return (fexpr__49349.cljs$core$IFn$_invoke$arity$1 ? fexpr__49349.cljs$core$IFn$_invoke$arity$1(G__49350) : fexpr__49349.call(null,G__49350));
})();
var fexpr__49346 = new cljs.core.Keyword(null,"calc-final","calc-final",1060997511).cljs$core$IFn$_invoke$arity$1(measure_49366);
return (fexpr__49346.cljs$core$IFn$_invoke$arity$2 ? fexpr__49346.cljs$core$IFn$_invoke$arity$2(G__49347,G__49348) : fexpr__49346.call(null,G__49347,G__49348));
})();
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(ref,cljs.core.assoc,new cljs.core.Keyword(null,"final","final",1157881357),measures.views.safe(p_49369,(3)));

console.log(["r-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(measure_49366)),"->p "].join(''),r_49368,p_49369);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(field,new cljs.core.Keyword(null,"final","final",1157881357))){
var r_49371 = new cljs.core.Keyword(null,"baseline","baseline",1151033280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(ref));
var p_49372 = new_value_49367__$1;
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(ref,cljs.core.assoc,new cljs.core.Keyword(null,"baseline","baseline",1151033280),measures.views.safe(r_49371,(3)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"RR","RR",-1849589574),measures.views.safe(measures.info.r_p__GT_RR(r_49371,p_49372),(2)),new cljs.core.Keyword(null,"PC","PC",-2096819416),measures.views.safe(measures.info.r_p__GT_PC(r_49371,p_49372),(1)),new cljs.core.Keyword(null,"OR","OR",-1220615924),measures.views.safe(measures.info.r_p__GT_OR(r_49371,p_49372),(2)),new cljs.core.Keyword(null,"HR","HR",1056134531),measures.views.safe(measures.info.r_p__GT_HR(r_49371,p_49372),(2))], 0));

console.log(["(r-p","->",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(measure_49366))].join(''),r_49371,p_49372);
} else {
var r_49373 = Number(new cljs.core.Keyword(null,"baseline","baseline",1151033280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(ref)));
var p_49374 = (function (){var fexpr__49351 = new cljs.core.Keyword(null,"calc-final","calc-final",1060997511).cljs$core$IFn$_invoke$arity$1(measure_49366);
return (fexpr__49351.cljs$core$IFn$_invoke$arity$2 ? fexpr__49351.cljs$core$IFn$_invoke$arity$2(r_49373,new_value_49367__$1) : fexpr__49351.call(null,r_49373,new_value_49367__$1));
})();
console.log("r-",new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(measure_49366),"->p ",r_49373,p_49374);

cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(ref,cljs.core.assoc,new cljs.core.Keyword(null,"final","final",1157881357),measures.views.safe(p_49374,(3)));

cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(ref,cljs.core.assoc,new cljs.core.Keyword(null,"RR","RR",-1849589574),measures.views.safe(measures.info.r_p__GT_RR(r_49373,p_49374),(2)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"PC","PC",-2096819416),measures.views.safe(measures.info.r_p__GT_PC(r_49373,p_49374),(1)),new cljs.core.Keyword(null,"OR","OR",-1220615924),measures.views.safe(measures.info.r_p__GT_OR(r_49373,p_49374),(2)),new cljs.core.Keyword(null,"HR","HR",1056134531),measures.views.safe(measures.info.r_p__GT_HR(r_49373,p_49374),(2))], 0));
...
var vec__49352 = measures.views.maybe_value(ref,field,new_value);
var err_field = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49352,(0),null);
var good_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49352,(1),null);
var error = vec__49352;
...
var fexpr__49355 = measures.info.measure_by(field);
return (fexpr__49355.cljs$core$IFn$_invoke$arity$1 ? fexpr__49355.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"step","step",1288888124)) : fexpr__49355.call(null,new cljs.core.Keyword(null,"step","step",1288888124)));
});
...
return measures.views.safe((function (){var fexpr__49356 = cljs.core.deref(ref);
return (fexpr__49356.cljs$core$IFn$_invoke$arity$1 ? fexpr__49356.cljs$core$IFn$_invoke$arity$1(field) : fexpr__49356.call(null,field));
})(),(cljs.core.truth_((function (){var fexpr__49357 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"baseline","baseline",1151033280),null,new cljs.core.Keyword(null,"final","final",1157881357),null], null), null);
return (fexpr__49357.cljs$core$IFn$_invoke$arity$1 ? fexpr__49357.cljs$core$IFn$_invoke$arity$1(field) : fexpr__49357.call(null,field));
...
var final$ = Number((function (){var G__49361 = new cljs.core.Keyword(null,"baseline","baseline",1151033280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(measures.db.state));
var G__49362 = new cljs.core.Keyword(null,"measure-value","measure-value",-185107611).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(measures.db.state));
var fexpr__49360 = new cljs.core.Keyword(null,"calc-final","calc-final",1060997511).cljs$core$IFn$_invoke$arity$1(measure);
return (fexpr__49360.cljs$core$IFn$_invoke$arity$2 ? fexpr__49360.cljs$core$IFn$_invoke$arity$2(G__49361,G__49362) : fexpr__49360.call(null,G__49361,G__49362));
})());
